                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <address>
                                ...
                                <?php echo e(Auth::guard('customer')->user()->name); ?><br>
                                <?php echo e(Auth::guard('customer')->user()->address); ?>,<br>
                                <?php echo e(Auth::guard('customer')->user()->state); ?>, <?php echo e(Auth::guard('customer')->user()->city); ?>, <?php echo e(Auth::guard('customer')->user()->zip); ?>
...
<?php echo $__env->make('customer.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project\online_room_booking\resources\views/customer/invoice.blade.php ENDPATH**/ ?>